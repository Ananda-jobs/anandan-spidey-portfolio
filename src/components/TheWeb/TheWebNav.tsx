...
export const TheWebNav: React.FC = () => {
  ...
  return (
    <motion.nav 
      ...
      className="absolute top-[35px] right-[35px] z-50 flex items-center text-[11px] md:text-[12px] lg:text-[13px] tracking-[1.5px] uppercase font-[500] text-white"
    >
      <div className="hidden md:flex items-center">
        {['Origin', 'Powers', 'Missions', 'The Web', 'Contact'].map((item) => {
          const isActive = item === 'The Web';
          return (
